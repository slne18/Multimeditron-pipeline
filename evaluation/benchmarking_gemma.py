...
model_answers_path = "/mloscratch/users/mberruye/evaluation/outputs_benchmarks/gemma/answers_GMAI-MMBench_2101_gemma.jsonl"
        ...
        [
            {
                ...
                "content": modalities + [
                    {"type": "text", "text": (
                        ...
                        + "\nPlease briefly explain your reasoning and conclude by clearly stating the final answer in the form 'Answer: X' where X is one of A, B, C, D, or E.")
                    }
                ]
            },
        ]
